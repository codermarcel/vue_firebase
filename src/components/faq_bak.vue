                          ...
                          <div class="panel panel-default">
                              <div class="panel-heading">
                                  <div class="panel-title">
                                      <i class="fa fa-angle-right"></i> <a class="accordion-toggle" data-toggle="collapse" data-parent="#faq1" href="#faq/q1"><strong>Welcome to our service</strong></a>
                                  </div>
                              </div>
                              <div id="#q1" class="panel-collapse extend">
